...
num_failed = 0
videos = util.files('dataset/videos')
sleep_time = 10
...
for vid_id in remaining:
    while True:
        ...
        try:
            ...
            file_loc = highResVideo.download('dataset/videos')
            rename(file_loc, 'dataset/videos/' + str(vid_id) + '.mp4')
